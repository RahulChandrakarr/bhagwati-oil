    ...
    <section className="relative  h-screen w-full overflow-hidden">
      ...
      <div className="container relative z-10 h-full flex flex-col justify-center">
        <div className="max-w-2xl">
          ...
          {/* Key Features */}
          <div className="mb-8 md:mb-10 flex flex-col md:flex-row gap-3 md:gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12 md:mb-16">
            <Link
              href="/products"
              className="px-6 py-3 md:px-8 md:py-4 yellow-theme-bg text-white font-semibold rounded-full text-base md:text-lg transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
            >
            ...
            <Link
              href="/about"
              className="px-6 py-3 md:px-8 md:py-4 bg-transparent border-2 border-white text-white font-semibold rounded-full text-base md:text-lg transition-all hover:bg-white/10 flex items-center justify-center gap-2"
            >
