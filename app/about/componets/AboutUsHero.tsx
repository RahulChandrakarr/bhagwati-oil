      ...
      <div className="container relative z-10 h-full flex flex-col justify-center items-center text-center">
        <div className="max-w-4xl px-4">
          ...
          <div className="flex justify-center">
            <Link
              href="#journey"
              className="px-8 py-4 md:px-10 md:py-5 bg-gradient-to-r from-[#D4AF37] to-[#B8941F] text-white font-semibold rounded-lg text-base md:text-lg transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2 hover:from-[#B8941F] hover:to-[#9A7A1A]"
            >
